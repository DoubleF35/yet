...
export default {
  ...
  profilo: {
    condividi: 'Share',
    condivisioneTesto: 'Take a look at {nome}’s profile on YET.',
    condivisione: {
      copiato: 'Link copied to your clipboard.',
      fallito: 'Copying failed. You can copy the address from the browser bar.',
    },
